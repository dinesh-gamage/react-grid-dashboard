...
class Dashboard extends React.Component<IProps, IState> {
    ...
    componentDidMount() {
        ...
        this.setState({ width: width - 200 }, this.loadFromLocalStorage);
    }
                ...
                <div className="main-block">
                    ...
                    <div className="content-block">
                        ...
                        <GridLayout className="layout"
                            ...
                            isResizable={this.state.enableResize}
                            isDraggable={this.state.enableDrag}
                            autoSize={false}
                            onLayoutChange={this.onLayoutChange}
                        >

                            {
                                this.state.selectedWidgets.map((widget: any, key: number) => this.renderWidget(widget, key))
                            }
